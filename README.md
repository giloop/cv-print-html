...
Adaptation du modèle de CV proposé par Min-Zhong "John" Lu's (projet github html-resume https://git.io/vVSYL) :
...
* Icons from [Font Awesome](https://fortawesome.github.io/Font-Awesome/) are used and are incorporated as a ~~git submodule~~ kit link in this repository.
